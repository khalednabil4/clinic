# Generated by Django 3.2.18 on 2024-12-02 19:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('administrator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='DataBase.administrator')),
            ],
        ),
        migrations.CreateModel(
            name='Clinic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Attachment', models.FileField(blank=True, null=True, upload_to='Chatattachments/')),
                ('ChatRoom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Message', to='DataBase.chatroom')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SentMessage', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Way', models.CharField(choices=[('EveryDayCome', '='), ('Percentage', '%'), ('EveryDrRevealed', '+'), ('BYMonth', '*')], max_length=20)),
                ('TimeStart', models.DateTimeField(auto_now=True)),
                ('TimeEnd', models.DateTimeField(blank=True, null=True)),
                ('IsActive', models.BooleanField(default=True)),
                ('Doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='DoctorPaymentConfig', to='DataBase.administrator')),
            ],
        ),
        migrations.AddField(
            model_name='clinic',
        ...
        migrations.AddField(
            model_name='chatroom',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='DataBase.patient'),
        ),
        migrations.AddField(
